...
```
xnoxos@htb[/htb]$ ./linpeas.sh...SNIP...
...
```
xnoxos@htb[/htb]$ sudo -l[sudo] password for user1:
...SNIP...
...
```
xnoxos@htb[/htb]$ sudo su -[sudo] password for user1:
whoami
root
...
```
xnoxos@htb[/htb]$ sudo -l    (user : user) NOPASSWD: /bin/echo
...
```
xnoxos@htb[/htb]$ sudo -u user /bin/echo Hello World!    Hello World!
...
```
xnoxos@htb[/htb]$ su -Password: password123
whoami
...
```
xnoxos@htb[/htb]$ vim id_rsaxnoxos@htb[/htb]$ chmod 600 id_rsaxnoxos@htb[/htb]$ ssh root@10.10.10.10 -i id_rsaroot@10.10.10.10#
...
```
xnoxos@htb[/htb]$ ssh-keygen -f keyGenerating public/private rsa key pair.
...
```
xnoxos@htb[/htb]$ ssh root@10.10.10.10 -i keyroot@remotehost#
```
