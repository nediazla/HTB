...
```
xnoxos@htb[/htb]$ locate mssqlclient/usr/bin/impacket-mssqlclient
...
![](https://academy.hackthebox.com/storage/modules/112/auth.png)
...
```
xnoxos@htb[/htb]$ python3 mssqlclient.py Administrator@10.129.201.248 -windows-authImpacket v0.9.22 - Copyright 2020 SecureAuth Corporation
