...
```
xnoxos@htb[/htb]$ sudo apt install mysql-server -yxnoxos@htb[/htb]$ cat /etc/mysql/mysql.conf.d/mysqld.cnf | grep -v "#" | sed -r '/^\s*$/d'[client]
port		= 3306
...
```
xnoxos@htb[/htb]$ sudo nmap 10.129.14.128 -sV -sC -p3306 --script mysql*Starting Nmap 7.80 ( https://nmap.org ) at 2021-09-21 00:53 CEST
...
```
xnoxos@htb[/htb]$ mysql -u root -h 10.129.14.132ERROR 1045 (28000): Access denied for user 'root'@'10.129.14.1' (using password: NO)
...
```
xnoxos@htb[/htb]$ mysql -u root -pP4SSw0rd -h 10.129.14.128Welcome to the MariaDB monitor.  Commands end with ; or \g.
