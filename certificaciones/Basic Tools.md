...
```
xnoxos@htb[/htb]$ ssh Bob@10.10.10.10Bob@remotehost's password: *********
...
```
xnoxos@htb[/htb]$ netcat 10.10.10.10 22SSH-2.0-OpenSSH_8.4p1 Debian-3
...
. In order to open a new window in

```
tmux
```

, we can hit the prefix 'i.e.
...
We see the numbered windows at the bottom. We can switch to each window by hitting the prefix and then inputting the window number, like
...
. We can also split a window vertically into panes by hitting the prefix and then
...
We can also split into horizontal panes by hitting the prefix and then
...
![](https://academy.hackthebox.com/storage/modules/77/getting_started_tmux_4.jpg)
...
![](https://academy.hackthebox.com/storage/modules/77/getting_started_vim_1.jpg)
...
![](https://academy.hackthebox.com/storage/modules/77/getting_started_vim_2.jpg)
